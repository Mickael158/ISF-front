    ...
    return(
        ...
        <ToastContainer />
            <div className="w-100 mt-2 mb-2">
                <h4 className="text-center mb-4">Modifier les apropos de l'institut !</h4>
                <div className="row">
                        ...
                        <div className="h-100 d-flex flex-column gap-3">
                            ...
                            <div className="d-flex justify-content-between">
                                <div className="col-md-12">
                                    <input type="text" className="form-control" value={agrement} onChange={(e) => setAgrement(e.target.value)} placeholder="Numero d'agrement" style={{'height':'50px'}}/>
                                </div>
                            </div>
                            <div className="d-flex justify-content-between">
                                <div className="col-md-12">
                                    <textarea type="text" className="form-control border" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Description de l'Institut" style={{'height':'400px'}}></textarea>
                                </div>
                            </div>
                            <div className="d-flex justify-content-between">
                                <div className="col-md-12">
                                    <textarea type="text" rows={6} className="form-control border" value={mot} onChange={(e) => setMot(e.target.value)} placeholder="Mot du directeur" style={{'height':'auto'}}></textarea>
                                </div>
                            </div>
