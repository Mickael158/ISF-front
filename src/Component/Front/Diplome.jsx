        ...
        <>
            ...
            <div className="col-lg-6">
                <div className="section-title text-center position-relative mb-4">
                    <h1 className="display-5 mb-1">DIPLOME DELIVRE</h1>
                    <h4>Notre Institut delivre les diplomes ci-dessous</h4>
                </div>
            </div>
        </div>
                ...
                <div className="card m-auto shadow d-flex align-items-center justify-content-center text-center bg-info text-white licence" style={{"width": "90%","height": "350px"}}>
                    <div className="card-body d-flex align-items-center justify-content-center text-center" style={{"columnGap": "30px !important"}}>
                      ...
                      <div style={{"display": "flex","flexDirection": "column","rowGap": "5px"}}>
                        ...
                        <h6 className="card-subtitle mb-2 font-weight-bold text-white">CATEGORI V</h6>
                      </div>
                    </div>
                  </div>
            </div>
                ...
                <div className="card m-auto shadow d-flex align-items-center justify-content-center text-center bg-info text-white master" style={{"width": "90%","height": "350px"}}>
                    <div className="card-body d-flex align-items-center justify-content-center text-center" style={{"columnGap": "30px !important"}}>
                      ...
                      <div style={{"display": "flex","flexDirection": "column","rowGap": "5px"}}>
                        ...
                        <h6 className="card-subtitle mb-2 font-weight-bold text-white">CATEGORI VIII</h6>
                      </div>
                    </div>
                  </div>
            </div>
