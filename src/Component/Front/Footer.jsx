            ...
            <div className="row">
                ...
                <div className="col-md-12 mb-5">
                    <div className="row">
                        ...
                        <a className="text-muted mr-4 d-flex flex-column align-items-center gap-2 justify-content-center" href="https://wa.me/261346040950" target="_blank" rel="noopener noreferrer"><i className="fab fa-2x fa-whatsapp"></i></a>
