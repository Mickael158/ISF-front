...
import { Carousel } from "react-bootstrap"; // Importer le composant Carousel
            ...
            <div className="bg-white p-5 my-5">
                ...
                <div className="d-flex justify-content-center flex-column mt-5 gap-5">
                    {Array.isArray(Evenement) && Evenement.length > 0 ? (
                                            ...
                                            {imagesArray.map((image, index) => (
                                                <Carousel.Item key={index}>
                                                    <img
                                                        ...
                                                        src={`${api_url}${image.trim()}`} // Ajoutez trim() pour enlever les espaces
                                                        alt={E.evenement}
                                                    />
                                                </Carousel.Item>
                                            ))}
                        ...
                        <div>Aucun evenement en ce moment</div>
                    )}
                </div>
            </div>
        </div>
